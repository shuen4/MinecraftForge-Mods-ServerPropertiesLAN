...
public class splan {
    ...
    @SubscribeEvent
    public void SendMessageToPlayer(EntityJoinLevelEvent event) {
        if (server==null)
            return;
    ...
    public void onServerStarting(ServerStartingEvent event) {
        ...
        rgetServerResourcePack=new ServerResourcePackInfo(new UUID(0, 0), ServerProperties.getStringProperty("resource-pack", ""), loadResourcePackSHA(), ServerProperties.getBooleanProperty("require-resource-pack", false), null);
        /** Debug info */
    ...
    public static boolean isLevelEnabled(Level level) {
        return level.dimension() == Level.NETHER ? instance.bisNetherEnabled : true;
    }
